...
| P1 | MC-dropout importance estimates must be reproducible across runs | Fixed random seed before each MC-dropout pass — seeded dropout is deterministic (resolved 2026-06-30) |
...
| P3 | Linear model ceiling on nonlinear dynamics in v1 | Decided (2026-06-30): v1 ships linear model; v2 upgrades to Bayesian/variational or nonlinear if ceiling hit in production |
